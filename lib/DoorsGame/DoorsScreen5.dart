...
import 'DoorsScreen6.dart'; // Ensure DoorsScreen6 is properly defined
          ...
          Padding(
            ...
            child: ClipRRect(
              ...
              child: LinearProgressIndicator(
                value: currentStep / 10, // The progress (5 out of 10 steps)
                ...
                Positioned.fill(
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildDoor(context, 'إضافة بيانات الطلب',
                          true), // Correct answer
                      _buildDoor(
