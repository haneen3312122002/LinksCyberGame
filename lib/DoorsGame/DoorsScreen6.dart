...
import 'afterdoor6.dart'; // تأكد من وجود هذه الشاشة
...
class _DoorsScreen6State extends State<DoorsScreen6> {
  ...
  Future<void> _playVideoAndNavigate(BuildContext context) async {
    _controller =
        VideoPlayerController.asset('assets/door1.mp4'); // Play door3.mp4
    ...
    _controller.addListener(() {
      if (_controller.value.position == _controller.value.duration) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => DesktopScreen6()),
        );
      }
    });
